...
button.addEventListener('click', (e) => {
    ...
    .then((data) => {
            const url = 'http://localhost:5000/users/userDB'
            ...
            .then((data)=> {
                ...
                if(userFound.roles.Student){
                    setTimeout(() => {
                        window.location.href = 'http://localhost:5000/verified/studentDash';
                    }, 500);
                }

                if(userFound.roles.Teacher){

                    setTimeout(() => {
                        window.location.href = 'http://localhost:5000/verified/teacherDash';
                    }, 500);
